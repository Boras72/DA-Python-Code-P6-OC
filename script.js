...
async function displayCategoryFilm(category_name, category_id) {
  ...
  section_category.insertAdjacentHTML(
    "afterend",
    `
         <button class="voir_btn" id="voir_plus_${category_name}" onclick="voirPlus('${category_name}')">Voir plus</button>
         <button class="voir_btn" id="voir_moins_${category_name}" onclick="voirMoins('${category_name}')">Voir moins</button>
         `
  );
